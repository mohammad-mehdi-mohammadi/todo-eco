...
import {UserStateType} from "../../../../redux/auth/types";
...
function Header() {
    ...
    const changeTheme = () => {
        isDark ? localStorage.removeItem("isDark") : localStorage.setItem("isDark", "true")
        theme.setIsDark(!isDark);
    }

    const {data} = useSelector((state: UserStateType) => state.user);
